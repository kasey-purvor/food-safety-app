...
export default function LevelFive({ pagesNeeded, totalRecords }) {
    ...
    return (
        <div>
            <Head>
                <title>Lvl 5 Takeaways & Sandwich Shops </title>
            </Head>
            <PageContainer>
                <div>
                    <p className="text-3xl font-bold  text-blue-700"> Level 5: Takeaways & Sandwich Shops</p>
...
function handleUrl(page, establishmentType) { 
    const url = `https://api1-ratings.food.gov.uk//enhanced-search/en-GB/%5e/%5e/alpha/7844/%5e/equal5/1/${page}/5000/json`;
    console.log(url);
    return url;
}
